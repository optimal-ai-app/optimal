...
import { ChevronLeft, Camera, Save, Clock } from 'lucide-react-native'

import { Card } from '@/src/components/default/Card'
import { Button } from '@/src/components/default/Button'
import { InputField } from '@/src/components/default/InputField'
...
export default function ChatBotSettingsScreen () {
  ...
  const personas: Persona[] = [
    ...
    },
    {
      ...
      image:
        'https://images.pexels.com/photos/4064826/pexels-photo-4064826.jpeg?auto=compress&cs=tinysrgb&w=600'
    },
    {
      id: '3',
      name: 'Accountability Partner',
      description:
        'Direct communication with a focus on commitment and follow-through.',
      image:
